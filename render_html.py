...
.card{background:var(--card);border:1px solid var(--line);border-radius:12px;padding:18px;box-shadow:0 1px 3px rgba(20,30,50,.04);display:flex;flex-direction:column}
...
<div class="wrap">
  ...
  <div class="grid">
    ...
    <div class="card">
      ...
      <div class="metric"><span class="k">SCFI 综合指数(最新)</span><span class="right"><span class="v" data-val="scfi"></span><span class="chg" data-val="scfi_chg"></span><span class="spark" data-spark="scfi" data-color="#c8102e"></span><button class="tbtn" onclick="openChart('freight','SCFI / CCFI 综合指数')">趋势</button></span></div>
      <div class="metric"><span class="k">CCFI 综合指数(最新)</span><span class="right"><span class="v" data-val="ccfi"></span><span class="chg" data-val="ccfi_chg"></span><span class="spark" data-spark="ccfi" data-color="#15616d"></span><button class="tbtn" onclick="openChart('freight','SCFI / CCFI 综合指数')">趋势</button></span></div>
      <div class="metric"><span class="k">单季货运量(最新)</span><span class="right"><span class="v" data-val="qvol25"></span><span class="chg" data-val="qvol_chg"></span><span class="spark" data-spark="qvol" data-color="#c8102e"></span><button class="tbtn" onclick="openChart('qvol','季度航运货运量（单季）')">趋势</button></span></div>
      <div class="metric"><span class="k">舱位利用率(最新)</span><span class="right"><span class="v" data-val="util"></span><span class="spark" data-spark="util" data-color="#d98a14"></span><button class="tbtn" onclick="openChart('util','舱位利用率')">趋势</button></span></div>
      <div class="metric"><span class="k">航线结构占比 (2025·按箱量)</span><span class="right"><span class="v" style="font-size:11px" data-val="route_mix25"></span><button class="tbtn" onclick="openChart('routemix','航线结构占比')">趋势</button></span></div>
      ...
      <div class="foot"><span>数据源：核心运营指标数据库(2021-2026).xlsx</span><span>更新：季频（货运量）/ 周频（运价）</span></div>
    </div>
    ...
    <div class="card">
      ...
      <div class="metric"><span class="k">全国港口吞吐量(最新)</span><span class="right"><span class="v" data-val="thru"></span><span class="chg" data-val="thru_yoy"></span><span class="spark" data-spark="thru" data-color="#15616d"></span><button class="tbtn" onclick="openChart('demand','港口吞吐量 & 出口总额')">趋势</button></span></div>
      <div class="metric"><span class="k">海关出口总额(最新)</span><span class="right"><span class="v" data-val="exp"></span><span class="chg" data-val="exp_yoy"></span><button class="tbtn" onclick="openChart('demand','港口吞吐量 & 出口总额')">趋势</button></span></div>
      <div class="metric"><span class="k">对东盟出口同比(最新)</span><span class="right"><span class="v" data-val="asean"></span><button class="tbtn" onclick="openChart('demand_yoy','分区域出口增速')">趋势</button></span></div>
      ...
      <div class="foot"><span>数据源：财报核心数据.xlsx（港口码头业务表）</span><span>更新：年频</span></div>
    </div>
    ...
    <div class="card">
      ...
      <div class="foot"><span>数据源：财报核心数据.xlsx</span><span>更新：季频</span></div>
    </div>
    ...
    <div class="card">
      ...
      <div class="metric"><span class="k">全球船队运力(最新)</span><span class="right"><span class="v" data-val="fleet"></span><span class="chg" data-val="fleet_yoy"></span><span class="spark" data-spark="fleet" data-color="#15616d"></span><button class="tbtn" onclick="openChart('supply','全球运力 & 闲置率/订单')">趋势</button></span></div>
      <div class="metric"><span class="k">闲置率(最新)</span><span class="right"><span class="v" data-val="idle"></span><button class="tbtn" onclick="openChart('supply','全球运力 & 闲置率/订单')">趋势</button></span></div>
      <div class="metric"><span class="k">手持订单/运力(最新)</span><span class="right"><span class="v" data-val="order"></span><button class="tbtn" onclick="openChart('supply','全球运力 & 闲置率/订单')">趋势</button></span></div>
      <div class="metric"><span class="k">美线停航率(最新)</span><span class="right"><span class="v" data-val="blank_us"></span><button class="tbtn" onclick="openChart('control','美线/欧线停航率')">趋势</button></span></div>
      <div class="metric"><span class="k">欧线停航率(最新)</span><span class="right"><span class="v" data-val="blank_eu"></span><button class="tbtn" onclick="openChart('control','美线/欧线停航率')">趋势</button></span></div>
      ...
      <div class="foot"><span>数据源：供给端 / 调控表</span><span>更新：季频</span></div>
    </div>
    ...
    <div class="card">
      ...
      <div class="foot"><span>数据源：财报核心数据.xlsx（成本结构表）</span><span>更新：年频</span></div>
    </div>

    <!-- 6 股东回报与资本运作（暂隐藏，不显示） -->
    <div class="card" style="display:none">
      <div class="hd"><div class="idx">6</div><h3>股东回报与资本运作</h3></div>
      <div class="desc">分红与回购是估值锚；分红来源财报核心数据.xlsx，回购来源中远海控_2026回购明细.xlsx。</div>
      ...
      <div class="metric"><span class="k">A股回购(截至07-31)</span><span class="right"><span class="v" data-val="bb_a5_shares"></span><span class="chg" data-val="bb_a5_amt"></span><span class="chg">/上限<span data-val="bb_a5_cap"></span></span></div>
      ...
      <div class="foot"><span>数据源：财报核心数据.xlsx / 回购明细.xlsx</span><span>更新：事件驱动</span></div>
    </div>
    ...
    <div class="card">
      ...
      <div class="metric"><span class="k">VLSFO 燃油价(最新)</span><span class="right"><span class="v" data-val="macro_fuel25"></span><span class="spark" data-spark="macro_fuel" data-color="#c8102e"></span><button class="tbtn" onclick="openChart('macroidx','宏观成本驱动：燃油/租船/EU碳价(2021=100)')">趋势</button></span></div>
      <div class="metric"><span class="k">租船费率 Harpex(最新)</span><span class="right"><span class="v" data-val="macro_charter25"></span><span class="spark" data-spark="macro_charter" data-color="#d98a14"></span><button class="tbtn" onclick="openChart('macroidx','宏观成本驱动：燃油/租船/EU碳价(2021=100)')">趋势</button></span></div>
      <div class="metric"><span class="k">EU ETS 碳价(最新)</span><span class="right"><span class="v" data-val="macro_ets25"></span><span class="spark" data-spark="macro_ets" data-color="#2e9e6b"></span><button class="tbtn" onclick="openChart('macroidx','宏观成本驱动：燃油/租船/EU碳价(2021=100)')">趋势</button></span></div>
      <div class="metric"><span class="k">亚欧绕航好望角比例(最新)</span><span class="right"><span class="v" data-val="macro_redsea_ratio25"></span><span class="spark" data-spark="macro_redsea_ratio" data-color="#d84315"></span><button class="tbtn" onclick="openChart('macroop','运力与需求：红海绕行+欧美PMI(水平值)')">趋势</button></span></div>
      <div class="metric"><span class="k">运力吸收率(最新)</span><span class="right"><span class="v" data-val="macro_redsea_absorb25"></span><span class="spark" data-spark="macro_redsea_absorb" data-color="#ff8f00"></span><button class="tbtn" onclick="openChart('macroop','运力与需求：红海绕行+欧美PMI(水平值)')">趋势</button></span></div>
      <div class="metric"><span class="k">欧美制造业/服务业 PMI(最新)</span><span class="right"><span class="v" style="font-size:12px" data-val="macro_pmi25"></span><span class="spark" data-spark="macro_pmi" data-color="#00897b"></span><button class="tbtn" onclick="openChart('macroop','运力与需求：红海绕行+欧美PMI(水平值)')">趋势</button></span></div>
      ...
      <div class="foot"><span>数据源：公开数据近似</span><span>更新：季频</span></div>
    </div>
  ...
  <div class="trend-zone">
    ...
    <details style="display:none"><summary>⑩ 股东回报与资本运作：分红 & 回购（暂隐藏）</summary>
      <div class="body fin-sec">
        ...
        <p class="fin-note">口径说明：分红为<b>年报+中报合计</b>（A+H 全体股东现金分红）；2021 年中报仅转增股本不派现，故当年分红比例仅 15.6%。回购数据来源：公司回购公告（A股第4/5轮、H股2026年内逐日及第4轮），完整明细见 <b>中远海控_2026回购明细.xlsx</b>。</p>
  ...
  <footer class="foot2">
    ...
    数据主源：行业供需与运价数据库(2025-2026).xlsx · 更新该文件后重跑 build_tracker.py 即可刷新
  </footer>
</div>
...
(function(){
  ...
  let html='<div class="qhead"><span class="qname">'+a.name+'</span>'
    ...
    +'<span class="qdate">行情快照 '+q.date+' 收盘 · '+q.note+'</span></div>'
    +'<div class="qrow">'
